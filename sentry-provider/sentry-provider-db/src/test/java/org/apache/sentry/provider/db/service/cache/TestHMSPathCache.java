...
public class TestHMSPathCache {
  ...
  public void testUpdateHandling() throws Exception {
    ...
    hmsCache.handleHMSNotification(new HMSUpdate(10, null));
    ...
    hmsCache.handleHMSNotification(update);
    waitToCommit(hmsCache);
    ...
    hmsCache.handleHMSNotification(new HMSUpdate(13, null));
    waitToCommit(hmsCache);
  ...
  public void testGetUpdatesFromSrcCache() throws InterruptedException {
    ...
    srcCache.handleHMSNotification(new HMSUpdate(10, null));
    ...
    srcCache.handleHMSNotification(update);
    waitToCommit(srcCache);
  ...
  public void testPathSerialization() throws InterruptedException {
    ...
    assertEquals("/[db1#db1[tbl11#db1.tbl11[part112#db1.tbl11[]part111#db1.tbl11[]]]]", ser);
  }
